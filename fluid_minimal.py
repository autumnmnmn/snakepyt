import torch as t;from PIL import Image as I;w,h,iters,save_every,r,dt,conv=2**10,2**10,100000,1,10,0.005,lambda f,k:t.nn.functional.conv2d(f.unsqueeze(0),k,bias=None,padding=[0],stride=[1])[0]
